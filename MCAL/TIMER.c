...
static void (*Timer0_OCA_Fptr) (void)=NULLPTR;
static void (*Timer0_OCB_Fptr) (void)=NULLPTR;
static void (*Timer0_ICU_Fptr) (void)=NULLPTR;
...
void Timer0_OCA_SetCallBack(void(*LocalFptr)(void))
{
	Timer0_OCA_Fptr=LocalFptr;
}
void Timer0_OCB_SetCallBack(void(*LocalFptr)(void))
{
	Timer0_OCB_Fptr=LocalFptr;
}
void Timer0_ICU_SetCallBack(void(*LocalFptr)(void))
{
	Timer0_ICU_Fptr=LocalFptr;
}
