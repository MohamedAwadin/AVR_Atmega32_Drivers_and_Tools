...
void PWM_Init(void)
{
	Timer1_Init(TIMER1_FASTPWM_ICR_TOP_MODE,TIMER1_SCALER_8,OC1A_NON_INVERTING,OC1B_DISCONNECTED);
...
{
	Timer1_Init(TIMER1_CTC_OCRA_TOP_MODE,TIMER1_SCALER_8,OC1A_DISCONNECTED,OC1B_DISCONNECTED);
	OCR1A=(time*1000)-1;
